...
% the QPD signal will begin to drop linearly as the nucleus pushed the bead
% out of the trap. 
% (2) Use the cursor to select the point at which the bead attaches to the
% nucleus and begins to be pushed out of the optical trap.
...
if doManualAdjust
    ...
    hold on
    scatter(xoffset,yoffset,'MarkerFaceColor','r')
...
% slope of the bead in the optical trap.
...
% (2) Use the largest value of fc and reassign fc:
fc = 1494;
